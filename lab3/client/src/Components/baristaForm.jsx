...
const BaristaForm = () => {
    ...
    const onCheckAnswer = () => {
        ...
        if (trueRecipe.temp == inputs['temperature'] && trueRecipe.syrup == inputs['syrup'] && trueRecipe.milk == inputs['milk'] && trueRecipe.blended == inputs['blended']){
            setScore(score + 1);
        }
    ...
    return (
        <div>
            ...
            <div className='instructions'>
                    <p>Type the correct ingredients for the drink above.</p>
                </div>
